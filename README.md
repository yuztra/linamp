...
Linamp is an unauthorized fork of Winamp, intended to trigger the corporate lawyers of Winamp. It includes copyrighted source code from Dolby, Shoutcast, and the likes to further piss them off.

It really whips the Winamp retards' ass.

## Usage

Building of Linamp is currently based around Visual Studio 2019 (VS2019) and Intel IPP libs (You need to use exactly v6.1.1.035).
There are different options of how to build Linamp:
...
#### libvpx
The Winamp retards take libvpx from https://github.com/ShiftMediaProject/libvpx, modify it and pack to archive.
Run unpack_libvpx_v1.8.2_msvc16.cmd to unpack.

#### libmpg123
The Winamp retards take libmpg123 from https://www.mpg123.de/download.shtml, modify it and pack to archive.
...
#### DirectX 9 SDK 
The Winamp retards take DirectX 9 SDK (June 2010) from Microsoft, modify it and pack to archive.
...
#### Intel IPP 6.1.1.035
The Winamp retards take Intel IPP 6.1.1.035, modify it and pack to archive.
